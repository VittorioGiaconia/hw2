...
function seleziona(event)
{
  ...
  fetch(URL3 + encodeURIComponent(autore_1) + '/'+encodeURIComponent(titolo_1) +'/'+ encodeURIComponent(descrizione_1) +'/'+ encodeURIComponent(new_img)+'/'+ encodeURIComponent(new_link));
  ...
  function onResponse(Response){
    ...
    console.log('sono giulia e sono qua');
