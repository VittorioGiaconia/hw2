...
<html>
    ...
    <script type= "text/javascript"> const URL = "<?php echo e(url('preferiti_view')); ?>/";</script>
    <script type= "text/javascript"> const URL1 = "<?php echo e(url('preferiti_delete')); ?>/";</script>
    ...
    <div>
      <span class='nome_username' >Preferiti <br><?php echo e($username); ?></span>
    </div>
    <div>
