<html>
    ...
    <script type= "text/javascript"> const URL = "<?php echo e(url('home_api')); ?>/";</script>
    <script type= "text/javascript"> const URL1 = "<?php echo e(url('home_insert')); ?>/";</script>
    ...
    <div>
      <span class='nome_username' >Home <br> Benvenuto, <?php echo e($username); ?> </span>
    </div>
    <div>
