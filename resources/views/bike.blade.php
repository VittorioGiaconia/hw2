<html>
    ...
    <script src= "{{ url('js/bike.js') }}" defer="true"></script> 
    <script type= "text/javascript"> const URL1 = "{{ url('bike_insert') }}/";</script>
  ...
  <nav class="media_nav">
    <a>Menu</a>
        ...
        <div>
      <span class='nome_username' >Bike <br> {{$username}} </span>
    </div>
    <div>
